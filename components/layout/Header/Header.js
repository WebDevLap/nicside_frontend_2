...
const Header = () => {
  ...
  const fetchProducts = async () => {
    ...
    let newProducts = await fetch(
      `/api/assortment?offset=${category?.offset}&${
        category?.search && "search=" + category?.search + "&"
      ...
      <div className={styles.subheader}>
        ...
        >
          ...
          <form>
            ...
            <p>
              Заказы отправляем как с наложенным платежом, так и по предоплате
              транспортными компаниями Autolight, Европочта, Белпочта
            </p>
            <b>По предоплате доставка осуществляется бесплатно</b>
          </form>

          <button
            style={{ padding: "6px 10px", marginTop: 20 }}
        ...
        <div className={styles.contacts}>
          ...
          <a href="https://t.me/plug_opt">Канал Telegram</a>
        </div>
      </div>
          ...
          <div>
            <div className={styles.search}>
              <div className={styles.input__wrapper}>
                <Icon
                  className={styles.search__search_icon}
                ...
                {search && (
                  <Icon
                    onClick={handleClean}
                    className={styles.search__close_icon}
                    icon="eva:close-fill"
                  />
                )}
              </div>
              <button className="primary__button" onClick={handleFind}>
                Найти
              </button>
            </div>
          ...
          <div>
            ...
            <div className={styles.cart__wrapper}>
              <div className={styles.cart__info}>
                ...
                <button onClick={handleOrder} disabled={summ <= 0}>
                  Оформить заказ
                </button>
              </div>
